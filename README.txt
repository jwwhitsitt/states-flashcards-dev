...
<head>
  ...
  <title>Week 7 – Final Boss (Abbreviations)</title>
...
<body>
  ...
  <script>
    ...
    const STATES = [{"state": "North Dakota", "abbr": "ND"}, {"state": "South Dakota", "abbr": "SD"}, {"state": "Nebraska", "abbr": "NE"}, {"state": "Kansas", "abbr": "KS"}];
